...
3. 修正领域专有词，例如：「那灵」「经纶」「召会」「活力排」「职事」「擘饼」「李常受」「倪柝声」「恢复本圣经」「生命读经」「晨兴圣言」「爱有效能」「膏油」「吃基督」「享受基督」「神圣罗曼史」「雷玛」「吗哪」「成为一灵」「生机的救恩」「法理的救赎」「生命之灵的律」「总括时期」「末后的亚当」「高峰真理」「属灵」「作王」「三一神」「赐生命的灵」「祂」「联结」「撒但」「在生命中作王」「承继」「结晶读经」「神人二性」「宇宙合并」「属灵新陈代谢」「终极完成之灵」「加强时期」「总括时期」「得胜者」等
