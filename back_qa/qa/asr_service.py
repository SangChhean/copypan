...
请对以下语音转写文本进行校对，规则如下：
1. 修正专有词错误，例如：「那灵」「经纶」「召会」「生机」「职事」「擘饼」「李常受」「倪柝声」「恢复本」「生命读经」「晨兴圣言」「爱有效能」等
2. 将繁体字统一改为简体字
3. 修正明显的同音字错误，如圣经书卷名、人名、地名等
4. 保持原句的语序和提问意图，不补充、不扩写、不润色；尤其不要将专有词组改写为看似通顺的普通表达，例如不能将「爱有效能」改为「爱的功效」
5. 如果文本已经正确，原样返回
6. 如果文本无法理解或无法校对，原样返回原文，不要任何解释
